...
exports.fetch = {
    ...
    convert: ({ method, fullUrl, postData, headersObj, cookies }, options) => {
        ...
        let includeFS = false;
        const { blank, push, join, unshift } = new code_builder_js_1.CodeBuilder({ indent: opts.indent });
        ...
        switch (postData === null || postData === void 0 ? void 0 : postData.mimeType) {
            ...
            case 'multipart/form-data':
                ...
                const contentTypeHeader = (0, headers_js_1.getHeaderName)(headersObj, 'content-type');
