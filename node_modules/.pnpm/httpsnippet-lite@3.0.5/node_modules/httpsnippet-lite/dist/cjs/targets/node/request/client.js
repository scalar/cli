...
exports.request = {
    ...
    convert: ({ method, url, queryObj, postData, headersObj, cookies }, options) => {
        ...
        let includeFS = false;
        const { push, blank, join, unshift } = new code_builder_js_1.CodeBuilder({ indent: opts.indent });
        ...
        push(`const options = ${(0, stringify_object_1.default)(reqOpts, { indent: '  ', inlineCharacterLimit: 80 })};`);
        blank();
