...
exports.nsurlsession = {
    ...
    convert: ({ allHeaders, postData, fullUrl, method }, options) => {
        ...
        if (Object.keys(allHeaders).length) {
            req.hasHeaders = true;
            blank();
            push((0, helpers_js_1.literalDeclaration)('headers', allHeaders, opts));
        }
        if (postData && (postData.text || postData.jsonObj || postData.params)) {
            ...
            switch (postData.mimeType) {
                ...
                case 'application/json':
                    if (postData.jsonObj) {
                        push(`${(0, helpers_js_1.literalDeclaration)('parameters', postData.jsonObj, opts)} as [String : Any]`);
                        blank();
                ...
                case 'multipart/form-data':
                     ...
                     */
                    push((0, helpers_js_1.literalDeclaration)('parameters', postData.params, opts));
                    blank();
