...
exports.httr = {
    ...
    convert: ({ url, queryObj, queryString, postData, allHeaders, method }, options = {}) => {
        ...
        // Construct headers
        const cookieHeader = (0, headers_js_1.getHeader)(allHeaders, 'cookie');
        const acceptHeader = (0, headers_js_1.getHeader)(allHeaders, 'accept');
        ...
        const otherHeaders = Object.entries(allHeaders)
            ...
            .map(([key, value]) => `'${key}' = '${(0, escape_js_1.escapeForSingleQuotes)(value)}'`)
            .join(', ');
