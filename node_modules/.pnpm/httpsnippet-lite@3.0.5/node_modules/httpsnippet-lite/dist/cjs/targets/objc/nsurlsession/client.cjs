...
exports.nsurlsession = {
    ...
    convert: ({ allHeaders, postData, method, fullUrl }, options) => {
        ...
        const { push, join, blank } = new code_builder_js_1.CodeBuilder({ indent: opts.indent });
        ...
        if (Object.keys(allHeaders).length) {
            req.hasHeaders = true;
            blank();
            push((0, helpers_js_1.nsDeclaration)('NSDictionary', 'headers', allHeaders, opts.pretty));
        }
        if (postData && (postData.text || postData.jsonObj || postData.params)) {
            ...
            switch (postData.mimeType) {
                ...
                case 'application/json':
                    if (postData.jsonObj) {
                        push((0, helpers_js_1.nsDeclaration)('NSDictionary', 'parameters', postData.jsonObj, opts.pretty));
                        blank();
                ...
                case 'multipart/form-data':
                    ...
                    push((0, helpers_js_1.nsDeclaration)('NSArray', 'parameters', postData.params || [], opts.pretty));
